...
public class AdminEndorsementsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.tvHeaderTitle)).setText("Service Management");
        ((TextView) view.findViewById(R.id.tvHeaderSubtitle)).setText("Oversee community service logs");
