...
public class AdminDashboardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // Force Light Theme locally — Admin is excluded from user theme preferences
        ...
        if (savedInstanceState != null) {
            currentNavId = savedInstanceState.getInt("nav_id", R.id.nav_overview);
        }
        ...
        if (currentNavId == R.id.nav_overview && binding.adminToolbar != null) {
        ...
        if (savedInstanceState == null) {
            ...
            binding.adminNavView.setCheckedItem(currentNavId);
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_emergencies) {
        ...
        } else if (id == R.id.nav_disaster_guides) {
            fragment = new AdminDisasterGuidesFragment();
            ...
            fragment = new AdminEvacuationFragment();
            title = "Evacuation Management";
        } else if (id == R.id.nav_barangays) {
            fragment = new AdminBarangaysFragment();
    ...
    private void checkSuspensionStatus() {
        new Thread(() -> {
            ...
            if (user != null && user.isSuspended) {
                runOnUiThread(() -> {
                    android.widget.Toast.makeText(this, "Account suspended by administrator.", android.widget.Toast.LENGTH_LONG).show();
                    SessionManager.getInstance(this).endSession();
