...
@Database(entities = {
        ActivityLog.class, User.class, EmergencyContact.class, Guide.class,
        Hospital.class, Endorsement.class, Notification.class,
        EmergencyAlert.class, BarangayZone.class, EndorsementStatusLog.class,
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract BarangayZoneDao barangayZoneDao();
    public abstract EndorsementStatusLogDao endorsementStatusLogDao();
    public abstract AlertNotificationDao alertNotificationDao();
    public abstract ChatMessageDao chatMessageDao();
    public abstract EvacuationCenterDao evacuationCenterDao();
    public abstract DisasterGuideDao disasterGuideDao();
    public abstract AssistantMessageDao assistantMessageDao();
    public abstract EvacuationResourceDao evacuationResourceDao();
                            ...
                            .addCallback(new RoomDatabase.Callback() {
                                ...
                                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                                    ...
                                    Executors.newSingleThreadExecutor().execute(() -> {
                                        ...
                                        // Seed ALL 31 Valencia City official barangays
                                        List<BarangayZone> zones = new ArrayList<>();
                                        zones.add(new BarangayZone("Bagontaas Zone", "7.930,7.960,125.080,125.110", "1111"));
                                        zones.add(new BarangayZone("Banlag Zone", "7.840,7.880,125.110,125.140", "1112"));
                                        zones.add(new BarangayZone("Barobo Zone", "7.884,7.925,125.013,125.054", "1113"));
                                        zones.add(new BarangayZone("Batangan Zone", "7.884,7.925,125.099,125.140", "1114"));
                                        zones.add(new BarangayZone("Catumbalon Zone", "7.828,7.869,125.082,125.123", "1115"));
                                        zones.add(new BarangayZone("Colonia Zone", "7.965,8.006,125.116,125.157", "1116"));
                                        zones.add(new BarangayZone("Concepcion Zone", "7.862,7.903,125.201,125.242", "1117"));
                                        zones.add(new BarangayZone("Dagat-Kidavao Zone", "7.805,7.846,125.112,125.153", "1118"));
                                        zones.add(new BarangayZone("Guinoyuran Zone", "7.875,7.916,124.979,125.020", "1119"));
                                        zones.add(new BarangayZone("Kahaponan Zone", "7.919,7.960,125.139,125.180", "1120"));
                                        zones.add(new BarangayZone("Laligan Zone", "7.863,7.904,125.164,125.205", "1121"));
                                        zones.add(new BarangayZone("Lilingayon Zone", "7.972,8.013,124.953,124.994", "1122"));
                                        zones.add(new BarangayZone("Lourdes Zone", "7.875,7.916,124.931,124.972", "1123"));
                                        zones.add(new BarangayZone("Lumbayao Zone", "7.926,7.967,125.225,125.266", "1124"));
                                        zones.add(new BarangayZone("Lumbo Zone", "7.890,7.920,125.095,125.120", "1125"));
                                        zones.add(new BarangayZone("Lurogan Zone", "7.947,7.987,125.026,125.066", "1126"));
                                        zones.add(new BarangayZone("Maapag Zone", "7.842,7.883,125.090,125.131", "1127"));
                                        zones.add(new BarangayZone("Mabuhay Zone", "7.822,7.863,125.116,125.157", "1128"));
                                        zones.add(new BarangayZone("Mailag Zone", "7.951,7.992,125.118,125.159", "1129"));
                                        zones.add(new BarangayZone("Mount Nebo Zone", "7.951,7.992,124.967,125.008", "1130"));
                                        zones.add(new BarangayZone("Nabago Zone", "7.944,7.985,125.136,125.177", "1131"));
                                        zones.add(new BarangayZone("Pinatilan Zone", "7.863,7.904,125.091,125.132", "1132"));
                                        zones.add(new BarangayZone("Poblacion Zone", "7.895,7.915,125.085,125.105", "1133"));
                                        zones.add(new BarangayZone("San Carlos Zone", "7.940,7.981,125.053,125.094", "1134"));
                                        zones.add(new BarangayZone("San Isidro Zone", "7.945,7.986,125.171,125.212", "1135"));
                                        zones.add(new BarangayZone("Sinabuagan Zone", "7.923,7.964,125.197,125.238", "1136"));
                                        zones.add(new BarangayZone("Sinayawan Zone", "7.850,7.891,125.123,125.164", "1137"));
                                        zones.add(new BarangayZone("Sugod Zone", "7.921,7.962,125.100,125.141", "1138"));
                                        zones.add(new BarangayZone("Tongantongan Zone", "7.888,7.929,125.145,125.186", "1139"));
                                        zones.add(new BarangayZone("Tugaya Zone", "7.894,7.935,124.997,125.038", "1140"));
                                        zones.add(new BarangayZone("Vintar Zone", "7.924,7.965,125.155,125.196", "1141"));
                                        getDatabase(context).barangayZoneDao().insertAll(zones);

                                        // Seed Disaster Guides
                                        List<DisasterGuide> dGuides = new ArrayList<>();
                                        dGuides.add(new DisasterGuide("dg_t1", "Typhoon Survival Basics", "Typhoon", "Comprehensive safety protocols to protect your home and family during severe tropical storms.", "Medium", "15 mins", 3120, "https://www.youtube.com/watch?v=TyphoonDummy", "[{\"order\": 1, \"description\": \"Regularly monitor official PAGASA reports and local emergency alerts for track updates.\"}, {\"order\": 2, \"description\": \"Trim large tree branches and secure outdoor furniture that could become hazardous projectiles.\"}, {\"order\": 3, \"description\": \"Prepare a 72-hour emergency kit with water, non-perishable food, and medical supplies.\"}]", false));
                                        dGuides.add(new DisasterGuide("dg_e1", "Earthquake: Duck, Cover, and Hold", "Earthquake", "The internationally recognized procedure for minimizing injury during seismic activity.", "Easy", "5 mins", 5430, "https://www.youtube.com/watch?v=EarthquakeDummy", "[{\"order\": 1, \"description\": \"Drop to your hands and knees immediately to prevent being knocked over by the tremor.\"}, {\"order\": 2, \"description\": \"Take cover under a sturdy piece of furniture or near an interior wall to shield from falling debris.\"}, {\"order\": 3, \"description\": \"Hold on to your shelter and protect your head/neck until all seismic shaking completely stops.\"}]", false));
                                        dGuides.add(new DisasterGuide("dg_f1", "Structural Fire Evacuation", "Fire", "Critical steps for identifying safe exits and preventing smoke inhalation during a fire.", "Medium", "10 mins", 4120, "https://www.youtube.com/watch?v=FireDummy", "[{\"order\": 1, \"description\": \"Keep low to the ground where the air is cleaner and cooler below the rising smoke layer.\"}, {\"order\": 2, \"description\": \"Check doorknobs for heat using the back of your hand before attempting to open any closed doors.\"}, {\"order\": 3, \"description\": \"Call emergency services once you reach the pre-designated safe assembly area outside.\"}]", false));
                                        dGuides.add(new DisasterGuide("dg_fl1", "Flood Preparedness & Escape", "Flood", "Safety guidelines for managing rising waters and identifying high-ground safe zones.", "Hard", "15 mins", 2980, "https://www.youtube.com/watch?v=FloodDummy", "[{\"order\": 1, \"description\": \"Disconnect main electrical breakers and gas valves if flooding appears imminent in your area.\"}, {\"order\": 2, \"description\": \"Identify the highest point in your vicinity and avoid crossing flowing water on foot or in vehicles.\"}, {\"order\": 3, \"description\": \"Wait for official rescue or clear-to-return signals from local authorities before re-entering homes.\"}]", false));
                                        getDatabase(context).disasterGuideDao().insertAll(dGuides);
                                    });
                                }
                            })
                            .build();
